...
<html>
    <head>
        ...
        <meta name="description" content="Krugersdorp Bowling Club Coaches">
        <title>Coaches - Krugersdorp Bowling Club</title>
                ...
                <div class="row media-row">
                    <div class="team-item col-lg-3 col-md-6">
                        <div class="item-image">
                            <img src="assets/images/coaches/nophoto.png" alt="" title="" media-simple="true">
                        </div>
                    ...
                    <div class="team-item col-lg-3 col-md-6">
                        <div class="item-image">
                            <img src="assets/images/coaches/tom.jpeg" alt="" title="" media-simple="true">
                        </div>
                        <div class="item-caption py-3">
                            <div class="item-name px-2">
                                <p class="mbr-fonts-style display-5">
