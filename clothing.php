...
<html>
    <head>
        ...
        <meta name="description" content="Krugersdorp Bowling Club Dress Code">
        <title>Dress Code - Krugersdorp Bowling Club</title>
                ...
                <div class="media-container-column">
                    <div class="row justify-content-center">
                        ...
                        <div class="card p-4 col-12 col-md-6 col-lg-4">
                            <div class="media pb-3">
                                <div class="card-img align-self-center">
                                    <span class="mbr-iconfont mbri-user" style="color: rgb(12, 55, 155);"
                                          media-simple="true"></span>
                                </div>
                                <div class="media-body">
                                    <h4 class="card-title py-2 align-left mbr-fonts-style display-5">
                                        <strong>Men</strong></h4>
                                </div>
                            </div>
                            <div class="card-box align-left">
                                <p class="mbr-text mbr-fonts-style display-7">
                        ...
                        <div class="card p-4 col-12 col-md-6 col-lg-4">
                            <div class="media pb-3">
                                <div class="card-img align-self-center">
                                    <span class="mbr-iconfont mbri-user2" style="color: rgb(12, 55, 155);"
                                          media-simple="true"></span>
                                </div>
                                <div class="media-body">
                                    <h4 class="card-title py-2 align-left mbr-fonts-style display-5">
